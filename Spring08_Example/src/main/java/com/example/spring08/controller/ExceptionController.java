...
public class ExceptionController {
	 ...
	 * 일회성 데이터를 전달하고 싶을 때는 컨트롤러의 매개변수에 RedirectAttributes 를 선언하고
	 * 해당 객체에 데이터를 담으면 리다일렉트 이동된 view page에서 해당 데이터를 추출해서 사용할 수 있따
	 */
	...
	public String password(PasswordException pe, RedirectAttributes ra) {
		 ...
		 * 해당 정보는 리다일렉트 이동된 view page에서 사용할 Model 객체에 자동으로 담긴다
		 */

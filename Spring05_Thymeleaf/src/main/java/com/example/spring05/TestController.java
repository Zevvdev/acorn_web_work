...
public class TestController {
    ...
    /*
     * 컨트롤러의 메소드에 UserDto를 선언하면
     * 폼 전송되는 파라미터가 자동으로 추출되어서
     * UserDto 의 필드에 담긴 채로 전달된다.
     * 
     * @ModelAttribute 어노테이션을 이용하면 
     * view page에서 해당 객체에 담긴 값을 활용할 수 있다.
     */
	...
	public String memberList(Model model) {
		...
		model.addAttribute("list", list);
		// /templates/member/list.html Thymeleaf 페이지로 응답
		return "member/list";
	}

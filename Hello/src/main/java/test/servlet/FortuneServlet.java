...
public class FortuneServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String[] imgs= {
        		"'/Hello/images/South Korea.png'",
        		"'/Hello/images/Spain.png'",
        		"'/Hello/images/Switzerland.png'",
        		"'/Hello/images/UK.png'",
        		"'/Hello/images/Turkey.png'",
        		"'/Hello/images/USA.png'",
            };

        // 랜덤하게 운세 선택
        Random rand = new Random();
        String fortuneToday = fortunes[rand.nextInt(fortunes.length)];
        String newimgs = imgs[rand.nextInt(imgs.length)];

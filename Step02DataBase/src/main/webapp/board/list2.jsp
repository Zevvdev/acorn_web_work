...
<body>
	...
	<div class="container pt-1">
		...
		<ul class="pagination">
			...
			<%if(startPageNum != 1){ %>
				<li class="page-item">
					<a class="page-link" href="list2.jsp?pageNum=<%=startPageNum-1 %>">&lsaquo;</a>
				</li>
			<%} %>			
			<%for(int i=startPageNum; i<=endPageNum ; i++){ %>
				<li class="page-item">
					<a class="page-link <%= i==pageNum ? "active":"" %>" href="list2.jsp?pageNum=<%=i %>"><%=i %></a>
				</li>
			<%} %>
			<%-- endPageNum 이 totalPageCount 보다 작을때 다음 page 가 있다 --%>		
			<%if(endPageNum < totalPageCount){ %>
				<li class="page-item">
					<a class="page-link" href="list2.jsp?pageNum=<%=endPageNum+1 %>">&rsaquo;</a>
				</li>
			<%} %>	
		</ul>
